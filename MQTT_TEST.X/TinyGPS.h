...
extern const float GPS_INVALID_F_ANGLE, GPS_INVALID_F_ALTITUDE, GPS_INVALID_F_SPEED;

  // properties
  extern unsigned long _time;
  extern unsigned long _new_time;
  extern unsigned long _date, _new_date;
  extern long _latitude, _new_latitude;
  extern long _longitude, _new_longitude;
  extern long _altitude, _new_altitude;
  extern unsigned long  _speed, _new_speed;
  extern unsigned long  _course, _new_course;
  extern unsigned long  _hdop, _new_hdop;
  extern unsigned short _numsats, _new_numsats;

  extern unsigned long _last_time_fix, _new_time_fix;
  extern unsigned long _last_position_fix, _new_position_fix;

  // parsing state variables
  extern uint8_t _parity;
  extern int _is_checksum_term;
  extern char _term[15];
  extern uint8_t _sentence_type;
  extern uint8_t _term_number;
  extern uint8_t _term_offset;
  extern int _gps_data_good;

#ifndef _GPS_NO_STATS
  // statistics
  extern unsigned long _encoded_characters;
  extern unsigned short _good_sentences;
  extern unsigned short _failed_checksum;
  extern unsigned short _passed_checksum;
#endif


  //TinyGPS();
  int encode(char c); // process one character received from GPS
